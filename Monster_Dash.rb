...
class Player_and_Rock
	def initialize	
		...
		@rockx0 = @rockx1 = @rockx2 = @rockx3 = @rockx4 = @rockx5 = 1280
		@rocky0 = @rocky2 = @rocky4 = 460 
		@rocky1 = @rocky3 = @rocky5 = -90 
		@rocksizex0 = @rocksizex1 = @rocksizex2 = @rocksizex3 = @rocksizex4 = @rocksizex5 = 1
		@rocksizey0 = @rocksizey1 = @rocksizey2 = @rocksizey3 = @rocksizey4 = @rocksizey5 = 1
		...
		@randomposition = @randomposition2 = @randomposition4 = 1
		@randomposition1 = @randomposition3 = @randomposition5 = 2
	...
	def update(jump_max)
		...
		if @xrock < 1280
			@rockx1 = @rockx0 + @rockdist[0]
			@rockx2 = @rockx1 + @rockdist[1]
			@rockx3 = @rockx2 + @rockdist[2] 
			@rockx4 = @rockx3 + @rockdist[3]
			@rockx5 = @rockx4 + @rockdist[4]
		end
		...
		if @rockx5 < -100
			...
			@randomposition = rand(1..2)
			if @randomposition == 1 
				@rockypost[0] = @rocktop
			elsif @randomposition	== 2 
				@rockypost[0] = @rockbottom
			end

			@randomposition1 = rand(1..2)
			if @randomposition1 == 1 
				@rockypost[1] = @rocktop
			elsif @randomposition1	== 2 
				@rockypost[1] = @rockbottom
			end

			@randomposition2 = rand(1..2)
			if @randomposition2 == 1 
				@rockypost[2] = @rocktop
			elsif @randomposition2	== 2 
				@rockypost[2] = @rockbottom
			end

			@randomposition3 = rand(1..2)
			if @randomposition3 == 1 
				@rockypost[3] = @rocktop
			elsif @randomposition3	== 2 
				@rockypost[3] = @rockbottom
			end 

			@randomposition4 = rand(1..2)
			if @randomposition4 == 1 
				@rockypost[4] = @rocktop
			elsif @randomposition4	== 2 
				@rockypost[4] = @rockbottom
			end

			@randomposition5 = rand(1..2)
				if @randomposition5 == 1 
			@rockypost[5] = @rocktop
				elsif @randomposition5	== 2 
			@rockypost[5] = @rockbottom
			end
	...
	def dontmove 
		...
		if @x < @rockx0 + 80 and @x > @rockx0 + 70
			if @y > 460 and @rocky0== 460  then
				@x = @rockx0 + 80 
			elsif  @y < 550 and @rocky0== -90 then 
				@x = @rockx0+ 80 
			end
		elsif @x > @rockx0 - 40 and @x < @rockx0- 30
			if @y > 460 and @rocky0== 460  then
				@x = @rockx0 -40
			elsif  @y < 550 and @rocky0== -90 then 
				@x = @rockx0-40
		...
		if @x < @rockx1 + 80 and @x > @rockx1 + 70
			if @y > 460 and @rocky1 == 460  then
				@x = @rockx1 + 80 
			elsif  @y < 550 and @rocky1 == -90 then 
				@x = @rockx1 + 80 
			end
		elsif @x > @rockx1 - 40 and @x < @rockx1- 30
			if @y > 460 and @rocky1== 460  then
				@x = @rockx1 -40
			elsif  @y < 550 and @rocky1== -90 then 
				@x = @rockx1-40
		...
		if @x < @rockx2 + 80 and @x > @rockx2 + 70
			if @y > 460 and @rocky2 == 460  then
				@x = @rockx2 + 80 
			elsif  @y < 550 and @rocky2 == -90 then 
				@x = @rockx2 + 80 
			end
		elsif @x > @rockx2 - 40 and @x < @rockx2- 30
			if @y > 460 and @rocky2== 460  then
				@x = @rockx2 -40
			elsif  @y < 550 and @rocky2== -90 then 
				@x = @rockx2-40
		...
		if @x < @rockx3 + 80 and @x > @rockx3 + 70
			if @y > 460 and @rocky3 == 460  then
				@x = @rockx3 + 80 
			elsif  @y < 550 and @rocky3 == -90 then 
				@x = @rockx3 + 80 
			end
		elsif @x > @rockx3 - 40 and @x < @rockx3- 30
			if @y > 460 and @rocky3== 460  then
				@x = @rockx3 -40
			elsif  @y < 550 and @rocky3== -90 then 
				@x = @rockx3-40
		...
		if @x < @rockx4 + 80 and @x > @rockx4 + 70
			if @y > 460 and @rocky4 == 460  then
				@x = @rockx4 + 80 
			elsif  @y < 550 and @rocky4 == -90 then 
				@x = @rockx4 + 80 
			end
		elsif @x > @rockx4 - 40 and @x < @rockx4- 30
			if @y > 460 and @rocky4== 460  then
				@x = @rockx4 -40
			elsif  @y < 550 and @rocky4== -90 then 
				@x = @rockx4-40
		...
		if @x < @rockx5 + 80 and @x > @rockx5 + 70
			if @y > 460 and @rocky5 == 460  then
				@x = @rockx5 + 80 
			elsif  @y < 550 and @rocky5 == -90 then 
				@x = @rockx5 + 80 
			end
		elsif @x > @rockx5 - 40 and @x < @rockx5- 30
			if @y > 460 and @rocky5== 460  then
				@x = @rockx5 -40
			elsif  @y < 550 and @rocky5== -90 then 
				@x = @rockx5-40
	...
	def move_right
		...
		if @x > @rockx0 - 40 and @x < @rockx0 + 80 
			if @y > 460 and @rocky0 == 460  then
				@x = @rockx0 - 40 
			elsif  @y < 550 and @rocky0 == -90 then 
				@x = @rockx0 - 40 
		...
		if @x > @rockx1 - 40 and @x < @rockx1 + 80 
			if @y > 460 and @rocky1 == 460  then
				@x = @rockx1 - 40 
			elsif  @y < 550 and @rocky1 == -90 then 
				@x = @rockx1 - 40 
		...
		if @x > @rockx2 - 40 and @x < @rockx2 + 80 
			if @y > 460 and @rocky2 == 460  then
				@x = @rockx2 - 40 
			elsif  @y < 550 and @rocky2 == -90 then 
				@x = @rockx2 - 40 
		...
		if @x > @rockx3 - 40 and @x < @rockx3 + 80 
			if @y > 460 and @rocky3 == 460  then
				@x = @rockx3 - 40 
			elsif  @y < 550 and @rocky3 == -90 then 
				@x = @rockx3 - 40 
		...
		if @x > @rockx4 - 40 and @x < @rockx4 + 80 
			if @y > 460 and @rocky4 == 460  then
				@x = @rockx4 - 40 
			elsif  @y < 550 and @rocky4 == -90 then 
				@x = @rockx4 - 40 
		...
		if @x > @rockx5 - 40 and @x < @rockx5 + 80 
			if @y > 460 and @rocky5 == 460  then
				@x = @rockx5 - 40 
			elsif  @y < 550 and @rocky5 == -90 then 
				@x = @rockx5 - 40 
	...
	def draw
		...
		#obstacle animtaion
		@rock1.draw_rot(@rockx0,@rocky0,0,0,0,0,@rocksizex0,@rocksizey0)
		@rock1.draw_rot(@rockx1,@rocky1,0,0,0,0,@rocksizex1,@rocksizey1)
		@rock1.draw_rot(@rockx2,@rocky2,0,0,0,0,@rocksizex2,@rocksizey2)
		@rock1.draw_rot(@rockx3,@rocky3,0,0,0,0,@rocksizex3,@rocksizey3)
		@rock1.draw_rot(@rockx4,@rocky4,0,0,0,0,@rocksizex4,@rocksizey4)
		@rock1.draw_rot(@rockx5,@rocky5,0,0,0,0,@rocksizex5,@rocksizey5)		
	end
end 
